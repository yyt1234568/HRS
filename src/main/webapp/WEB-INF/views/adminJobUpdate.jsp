                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <form role="form" action="/admin/addOrUpdateJob">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <select id="dept" name="dept_id" onchange="serviceTypeChange(this.options[this.selectedIndex].value);">
                                                ...
                                                <c:forEach items="${requestScope.depts}" var="dept">
                                                    <c:if test="${dept.id==requestScope.job.dept.id}" >
                                        ...
                                        <div class="form-group">
                                            <label for="deptname">职位名字</label>
                                            <input type="text" class="form-control" name="name" id="deptname" value="${requestScope.job.name}">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
