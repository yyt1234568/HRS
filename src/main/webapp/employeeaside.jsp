...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/WEB-INF/views/index.jsp" class="brand-link">
        <img src="/static/dist/img/emplyeeLTELogo.png" alt="emplyeeLTE Logo" class="brand-image img-circle elevation-3"
             style="opacity: .8">
        <span class="brand-text font-weight-light">emplyeeLTE 3</span>
    </a>
